...
![.claude folder structure](./screenshots/images/ss35.png)
...
![user-prompt-guard.sh hook script](./screenshots/images/ss36.png)
...
![pre-tool-guard.sh hook script](./screenshots/images/ss37.png)
...
![post-tool-logger.sh hook script](./screenshots/images/ss38.png)
...
![settings.json permissions and hooks](./screenshots/images/ss39.png)
...
![UserPromptSubmit hook blocking destructive prompt](./screenshots/images/ss40.png)
...
![PreToolUse hook approval gate on terraform command](./screenshots/images/ss41.png)
...
![terraform validate success](./screenshots/images/ss42.png)

#### Screenshot 9 — `.claude/deploy.log` showing the logged command

![deploy.log queried after terraform validate](./screenshots/images/ss42.png)
